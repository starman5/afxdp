...
// For counting the number of processed requests with padding to reduce false sharing
...
void* handle_request(void* arg) {
    ...
    inet_pton(AF_INET, INTERFACE_IP, &(server_addr.sin_addr));
...
int main() {
    // Initialize a count for each thread, to prevent false sharing from a common counter
    void* rawPtr_Count;
